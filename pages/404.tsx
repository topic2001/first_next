...
export default function Custom404() {
  return (
    <div className={styles.container}>
                ...
                <g id="Group" transform="translate(67.000000, 1.000000)">
                  <g id="Vector">
                    <g fill="#FBC02D">
                      <g
                        id="path0_fill-link"
                        transform="translate(34.026705, 37.235775) rotate(-74.247933) translate(-34.026705, -37.235775) translate(3.025380, 11.234649)"
                      >
                        <path
                          d="M30.9932248,51.9489495 C48.1103564,51.9489495 61.9864496,40.3197459 61.9864496,25.9744248 C61.9864496,11.6292036 48.1103564,0 30.9932248,0 C13.8761931,0 0,11.6292036 0,25.9744248 C0,40.3197459 13.8761931,51.9489495 30.9932248,51.9489495 Z"
                          id="path0_fill"
                        ></path>
                      </g>
                    </g>
                    ...
                    >
                      <g
                        id="path1_fill-link"
                        transform="translate(0.725900, 0.235000)"
                      >
                        <path
                          d="M12.102,-7.92444e-08 C7.18283,3.65613 3.32728,9.47269 1.33303,16.7849 C-2.52252,31.0771 2.26368,46.3663 12.102,53.8448 L23.5357,58.3318 C34.7035,59.3289 45.4724,50.8534 49.195,36.8936 C50.6575,31.5756 50.9234,25.9253 49.9927,20.7734 C42.0157,19.6101 32.8422,16.1202 29.7843,10.9684 C26.1947,5.318 18.7495,1.49569 12.102,-7.92444e-08 Z"
                          id="path1_fill"
                        ></path>
                      </g>
                    </g>
                    <g
                      transform="translate(8.000000, 18.000000)"
                      fill="#FFA000"
                    >
                      <g
                        id="path2_fill-link"
                        transform="translate(0.757000, 0.212000)"
                      >
                        <path
                          d="M1.30188,8.97412 C-3.08547,25.5929 3.96088,43.3749 17.2559,49.0253 C30.5509,54.5095 44.7765,45.7016 49.2968,29.0828 C50.2275,25.4267 50.7593,21.6044 50.6263,17.9482 C45.1754,14.9569 38.6608,13.295 33.7417,14.9569 C26.4294,17.2835 10.4754,7.47844 5.02448,-1.58489e-07 C3.42908,2.659 2.23253,5.65037 1.30188,8.97412 Z"
                          id="path2_fill"
                        ></path>
                      </g>
                    </g>
                    <g
                      transform="translate(8.000000, 33.000000)"
                      fill="#FBC02D"
                    >
                      <g
                        id="path3_fill-link"
                        transform="translate(0.801200, 0.335000)"
                      >
                        <path
                          d="M0.194064,1.26791e-06 C-1.26839,14.6245 5.64501,28.9166 17.2117,33.7361 C28.1136,38.3893 39.8132,33.0713 46.0618,21.7706 C37.553,20.9396 26.917,17.2835 23.4603,11.7993 C18.6741,4.32087 7.50631,0.166189 0.194064,1.26791e-06 Z"
                          id="path3_fill"
                        ></path>
                      </g>
                    </g>
                    <g
                      transform="translate(9.000000, 46.000000)"
                      fill="#E64A19"
                    >
                      <g
                        id="path4_fill-link"
                        transform="translate(0.793000, 0.131000)"
                      >
                        <path
                          d="M16.2199,20.9396 C25.3934,24.7619 34.9658,21.7706 41.6133,14.1259 C36.4283,11.6331 30.5785,10.3036 26.0582,11.7993 C19.8095,13.7936 6.9134,6.6475 -2.53582e-07,-6.33955e-07 C2.26015,9.47269 8.10995,17.6159 16.2199,20.9396 Z"
                          id="path4_fill"
                        ></path>
                      </g>
                    </g>
      ...
      <h2 className={styles.text}>Hmm...</h2>
      ...
      <p className={styles.centerText}>
        Its look like youre lost...
        <br />
        Thats a trouble?
      </p>

      <button className={styles.goback} type="button">
